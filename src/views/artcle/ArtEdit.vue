<template>
  <div class="container">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item
        >{{ this.$route.params.title }}文章</el-breadcrumb-item
      >
    </el-breadcrumb>
    ...
    submitForm(artForm) {
      this.$refs[artForm].validate((valid) => {
        ...
        if (this.title === "添加") {
          ...
          let index = this.allArtData.findIndex(
            (item) => item.id === this.temEditData.id
          );
